...
/**
 * Created by Waqar Malik on 28-Apr-17.
 */

public class CarUpdateActivity extends ParentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        input_regno.setText(getIntent().getStringExtra("regno").toString());
        input_model.setText(getIntent().getStringExtra("model").toString());
        input_model_year.setText(getIntent().getStringExtra("modelyear").toString());
        input_manufacturer.setText(getIntent().getStringExtra("manu").toString());
        input_color.setText(getIntent().getStringExtra("color").toString());
        input_registration_city.setText(getIntent().getStringExtra("regcity").toString());
        input_engine_capacity.setText(getIntent().getStringExtra("enginecapacity").toString());
        input_engine_type.setText(getIntent().getStringExtra("enginetype").toString());
        ...
        button.setOnClickListener(new View.OnClickListener()

                                  {
                                      public void onClick(View v) {
                                          ...
                                          hideSoftKeyboard(v);
                                          showLoading(CarUpdateActivity.this);
                                          ...
                                          StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                                                  new Response.Listener<String>() {
                                                      ...
                                                      public void onResponse(String response) {
                                                          ...
                                                          hideLoading(CarUpdateActivity.this);
                                                             ...
                                                             // String successMessage = parent.getString("message");
                                                              ...
                                                              if (successStatus == 0) {
                                                                 ...
                                                                 /* JSONObject dataObject = new JSONObject(parent.getString("data"));
                                                                  ...
                                                                  Intent schoolActivityIntent = new Intent(CarUpdateActivity.this, MainActivity.class);
                                              ...
                                              protected Map<String, String> getParams() {
                                                  ...
                                                  params.put("method", "updateCarDetails");
                                          ...
                                          RequestQueue requestQueue = Volley.newRequestQueue(CarUpdateActivity.this);
