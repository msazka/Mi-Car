...
public class MiCarSignInGoogle extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignInButton signInButtonGoogle = (SignInButton) findViewById(R.id.login_via_google);
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            findViewById(R.id.login_via_google).setVisibility(View.GONE);
            findViewById(R.id.sign_out_and_disconnect).setVisibility(View.VISIBLE);
        } else {
            mStatusTextView.setText(R.string.signed_out);

            findViewById(R.id.login_via_google).setVisibility(View.VISIBLE);
